...
//File Name						: DeliverableMailHistoryRepository.java
//Author						: anil
//Contact						: anilagrawal038@gmail.com
//Date written (DD MMM YYYY)	: 22-Sep-2017 10:05:01 PM
//Description					:  
//-----------------------------------------------------------------------------------------------------------
//					CHANGE HISTORY
//-----------------------------------------------------------------------------------------------------------
...
import com.san.domain.mail.history.DeliverableMailHistory;

@Repository
public interface DeliverableMailHistoryRepository extends JpaRepository<DeliverableMailHistory, Long> {
